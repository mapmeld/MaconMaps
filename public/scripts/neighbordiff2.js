...
function init(){
  ...
  map.on('zoomend', function(e){
    ...
    $("#thefinal")[1].href="/collegehill2.html?table=lynmore&user=mapmeld&message=true" + position;
    $("#changemap")[1].href="/diffmap.html?table=lynmore&user=mapmeld&message=true" + position;
    $("#kitchensink")[1].href="/everything.html?table=lynmore&user=mapmeld&message=true" + position;
  });
