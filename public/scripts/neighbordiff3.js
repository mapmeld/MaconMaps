...
function init(){
  ...
  cartodb = new L.CartoDBLayer({
    ...
    tile_style: "#" + table_name + "{polygon-fill:orange;polygon-opacity:0.5;stroke:#000;stroke-width:1;} #" + table_name + "[status='Demolished']{polygon-fill:red;} #" + table_name + "[status='Renovated']{polygon-fill:green;} #" + table_name + "[status='Moved']{polygon-fill:blue;}",
